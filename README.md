...
The pipeline blends both the **text prompts** and the **images** to produce a morphing effect in order to generate a video that evolves from one verse to the next.
